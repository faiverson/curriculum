  ...
  return (
    <main>
      ...
      <section className="cover">
        <div className="section-center flex px-12 flex-col md:flex-row">
          <div className="info">
            ...
            <div className="hidden relative mt-4 md:mt-8 md:block">
          ...
          <div className="profile">
            ...
            <svg className="confetti-yellow" viewBox="0 0 56 34">
              <path d="M0 33.5L36.5 0L55.5 12L36.5 33.5H0Z" fill="#F3FD53" />
            </svg>
            <svg className="confetti-black" viewBox="0 0 43 51">
              <path d="M9.5 38L0 0L42.5 30L36 50.5L9.5 38Z" fill="black" />
            </svg>
            <svg className="confetti-blue" viewBox="0 0 25 35">
      ...
      <section className="summary">
        <div className="section-center">
          ...
          <div className="summary-wrapper">
            ...
            <div className="break-words text-bold-grey text-base pr-4 lg:pr-12 lg:max-w-[38.11em]">
      ...
      <section className="overview">
        <div className="section-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:gap-x-44 lg:gap-y-2">
      ...
      {/* Accomplishments */}
      <section className="accomplishments overflow-hidden relative">
        <div className="icon">
      ...
      <section className="languages">
        <div className="section-center">
          ...
          <div className="flex gap-12 text-white px-4">
