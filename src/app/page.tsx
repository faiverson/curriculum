...
export default function Home() {
  ...
  return (
    <main>
      <header>
        <div className="box-border dark:bg-bold-black border-[0.1rem]-bold-black-alternative bg-neutral-100">
          <div className="header">
            <button className='dark:text-white text-bg-bold-black hover:scale-110 active:scale-100 duration-200 ' onClick={() => theme === 'dark' ? setTheme('light') : setTheme('dark')}>
              {theme === 'dark'
