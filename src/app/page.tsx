...
export default function Home() {
  return (
    <main>
      <header>
        <div className="box-border bg-bold-black border-[0.1rem]-bold-black-alternative">
      ...
      <section className="cover">
        <div className="section-center flex px-12 flex-col lg:flex-row">
          <div className="info">
            ...
            <div className="button-wrapper hidden lg:block">
      ...
      <section className="overview">
        <div className="section-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-x-44 lg:gap-y-2">
      ...
      <section className="work">
        <div className="section-center">
          ...
          <div className="items text-white">
            <Accordion company={'OnyxCorp LLC'} date={'2017.04 - 2023.09 (6 years & 5 months)'} position={'Senior Software Engineer'} alignment={'left'}>
            ...
            <Accordion company={'Rack Performance'} date={'2018.02 - 2018.07 (5 months)'} position={'Senior Software Engineer'} alignment={'right'}>
            ...
            <Accordion company={'Jakentra'} date={'2017.02 - 2017.04 (2 months)'} position={'Software Developer'} alignment={'right'}>
            ...
            <Accordion company={'ProcessMaker Inc'} date={'2016.05 - 2016.11 (6 months)'} position={'Senior Software Engineer'} alignment={'left'}>
            ...
            <Accordion company={'FEM Inc'} date={'2014.05 - 2016.11 (2 years & 1 month)'} position={'Software Developer'} alignment={'right'}>
            ...
            <Accordion company={'Hanger'} date={'2013.11 - 2014.09 (10 months)'} position={'Software Developer'} alignment={'left'}>
            ...
            <Accordion company={'LBSI'} date={'2013.12 - 2014.05 (5 months)'} position={'Software Developer'} alignment={'right'}>
            ...
            <Accordion company={'Fanattac'} date={'2012.11 - 2013.06 (8 months)'} position={'Software Developer'} alignment={'left'}>
            ...
            <Accordion company={'Santex Group'} date={'2009.12 - 2013.03 (3 years & 3 months)'} position={'Software Developer Engineer'} alignment={'left'}>
      ...
      <section className="accomplishments overflow-hidden">
        <div className="section-center relative">
          <h2 className="subtitle">Accomplishments 🎖</h2>
          <div className="text-white flex align-bottom gap-16">
            <ul className="flex flex-wrap flex-col lg:flex-row mx-2 lg:mx-4 bullet">
          ...
          <div className="absolute w-screen top-1/4 left-0 hidden">
            <div className="icon">
      ...
      <section className="languages">
        <div className="section-center">
          ...
          <div className="flex gap-12 text-white px-4 lg:px-12">
      ...
      <section className="timeline">
        <div className="section-center px-2 lg:px-12">
            ...
            <div className="row">
              <div className="item-wrapper">
                ...
                <div className="item">
                  ...
                  <div className="date">Jan 2003 - Nov2003</div>
                </div>
              </div>
            </div>
            <div className="row">
