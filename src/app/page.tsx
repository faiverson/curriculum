        ...
        <header>
          <div className="box-border dark:bg-bold-black border-[0.1rem]-bold-black-alternative bg-neutral-100 h-12 print:pt-40">
            <div className='h-full flex flex-row-reverse justify-between'>
              <button className='pr-2 dark:text-white text-bg-bold-black hover:scale-110 active:scale-100 duration-200 print:hidden' onClick={() => theme === 'dark' ? setTheme('light') : setTheme('dark')}>
                {theme === 'dark'
